...
if [ -d /proc/sys/walt ]; then
	...
	echo 8500000 8500000 5000000 5000000 5000000 5000000 > /proc/sys/walt/sched_util_busy_hyst_cpu_ns
	...
	echo 1113600 0 0 0 0 0 0 > /proc/sys/walt/input_boost/input_boost_freq
...
echo "0:595200 2:633600" > /data/vendor/perfd/default_scaling_min_freq
