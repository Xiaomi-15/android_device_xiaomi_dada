...
if [ -d /proc/sys/walt ]; then
	...
	echo 8500000 8500000 5000000 5000000 5000000 2000000 > /proc/sys/walt/sched_util_busy_hyst_cpu_ns
	echo 255 > /proc/sys/walt/sched_util_busy_hysteresis_enable_cpus
	echo 1 1 15 15 15 15 > /proc/sys/walt/sched_util_busy_hyst_cpu_util
...
echo "0:595200 2:633600 5:633600" > /data/vendor/perfd/default_scaling_min_freq
